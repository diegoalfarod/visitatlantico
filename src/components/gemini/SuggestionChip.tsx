...
export function SuggestionChip({
    ...
    const getVariantStyles = () => {
        switch (variant) {
            case "primary":
                return "bg-[#E40E20] hover:bg-[#D34A78] text-white border-[#E40E20]";
            case "accent":
                return "bg-gray-600 hover:bg-gray-700 text-white border-gray-600";
            default:
                return "bg-white hover:bg-gray-50 text-[#4A4F55] border-[#C1C5C8] hover:border-gray-300";
        }
    };
    ...
    return (
        <button
            onClick={onClick}
            className={`group relative inline-flex items-center gap-2 rounded-lg font-medium transition-all duration-200 hover:shadow-md border ${small ? "px-3 py-1.5 text-xs" : "px-4 py-2 text-sm"} ${getVariantStyles()} font-poppins`}
        ...
        >
            ...
            <div className="flex items-center gap-2">
                ...
                {/* Text */}
                <span className="font-medium font-merriweather-sans" style={{ fontFamily: 'Merriweather Sans' }}>
                    {textWithoutEmoji}
                </span>
