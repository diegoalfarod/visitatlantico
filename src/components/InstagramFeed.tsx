...
export default function InstagramFeed() {
  ...
  return (
    <section id="instagram" className="relative py-16 sm:py-20 bg-white border-t border-gray-200">
      {/* Header con ancho máximo para legibilidad */}
      ...
      {/* Widget Container - Ancho completo */}
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
      ...
      >
        {/* Instagram Widget - Sin restricción de ancho */}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-2 border border-gray-900 text-gray-900 px-6 py-2.5 rounded-full font-medium hover:bg-gray-900 hover:text-white transition-colors duration-200"
          >
