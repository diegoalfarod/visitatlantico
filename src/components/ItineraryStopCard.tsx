...
import { MapPin, Clock, Info, Camera, Utensils, Star, ChevronRight, ExternalLink } from "lucide-react";
...
export interface Stop {
  ...
  // Additional properties for enhanced experience
  rating?: number;
  cost?: string;
  amenities?: string[];
  photos?: string[];
    ...
    <div className="p-6">
      ...
      <div className="space-y-4">
        ...
        {stop.tip && (
          <motion.div 
            layout
            className="mt-4 rounded-xl overflow-hidden border border-amber-200"
          >
            <button
