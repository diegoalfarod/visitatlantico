...
export default function DestinationsPage() {
  ...
  // Carga destinos desde Firestore
  useEffect(() => {
          ...
          snap.docs.map(async (doc) => {
            ...
            if (normalizedPath) {
              try {
                ...
                console.error("Error al obtener URL:", normalizedPath, err);
              }
            }
            return {
              id: doc.id,
  ...
  // Contar filtros activos y resetear paginación
  useEffect(() => {
    let cnt = 0;
    if (search.trim()) cnt++;
  ...
  return (
    <>
      <Navbar />
      <main className="min-h-screen bg-gradient-to-b from-white to-indigo-50 dark:from-gray-900 dark:to-gray-800">
